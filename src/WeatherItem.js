...
class WeatherItem extends React.Component {
    ...
    selectIcon = () => {
        if (this.props.weath.weather === "Snowy"){
            return (
                <img src={snowyURL} height="40" width="40">
                </img>
            );
        }
        else if (this.props.weath.weather === "Sunny"){
            return (
                <img src={sunnyURL} height="40" width="40">
                </img>
            );
        }
        else if (this.props.weath.weather === "Cloudy"){
            return (
                <img src={cloudyURL} height="40" width="40">
                </img>
            );
        }
        else if (this.props.weath.weather === "Rainy"){
            return (
    ...
    render() {
        ...
        return (
            <div className="weather-item">
                <div className="day">
                {this.props.weath.day}
                </div>
                <div className="temperature">
                    {this.props.weath.temperature}
                    <span>&deg;C</span>
                </div>
                {this.selectIcon()}
